...
1.1.3 - add a welcome page that helps novices navigate options and prompts them for key steps
1.1.4 - add a 'light' scoring mode that doesn't require student IDs and generates a simplified report and score sheet
